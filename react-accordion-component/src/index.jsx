...
const entries = [
  ...
  },
  {
    ...
    details: 'Cascading Style Sheets (CSS) is a style sheet language used for describing the presentation of a document written in a markup langauge like HTLM. CSS is a cornerstone technology of the World Wide Web alongside HTML and JavaScript.'
  },
  {
    topic: 'JavaScript',
...
const element = <Accordion entries={entries} />;
